...
class YCDUI_LIB_CLASS CListUI : public CVerticalLayoutUI, public IListUI
{
public:
    CListUI();
...
class YCDUI_LIB_CLASS CListBodyUI : public CVerticalLayoutUI
{
public:
...
class YCDUI_LIB_CLASS CListHeaderUI : public CHorizontalLayoutUI
{
public:
    CListHeaderUI();
...
class YCDUI_LIB_CLASS CListHeaderItemUI : public CControlUI
{
public:
    CListHeaderItemUI();
...
class YCDUI_LIB_CLASS CListElementUI : public CControlUI, public IListItemUI
{
public:
    CListElementUI();
...
class YCDUI_LIB_CLASS CListLabelElementUI : public CListElementUI
{
public:
    CListLabelElementUI();
...
class YCDUI_LIB_CLASS CListTextElementUI : public CListLabelElementUI
{
public:
    CListTextElementUI();
    ~CListTextElementUI();
...
class YCDUI_LIB_CLASS CListContainerElementUI : public CContainerUI, public IListItemUI
{
public:
