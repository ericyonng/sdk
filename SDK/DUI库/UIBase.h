...
void YCDUI_LIB_CLASS __Trace(LPCTSTR pstrFormat, ...);
LPCTSTR YCDUI_LIB_CLASS __TraceMsg(UINT uMsg);
...
//class YCDUI_LIB_CLASS CPoint : public tagPOINT
//{
//public:
//    CPoint();
...
//class YCDUI_LIB_CLASS CSize : public tagSIZE
//{
//public:
//    CSize();
...
class YCDUI_LIB_CLASS CWHRect : public tagRECT
{
public:
    CWHRect();
...
class YCDUI_LIB_CLASS CStdPtrArray
{
public:
...
class YCDUI_LIB_CLASS CStdValArray
{
public:
...
class YCDUI_LIB_CLASS CStdString
{
public:
...
class YCDUI_LIB_CLASS CStdStringPtrMap
{
public:
...
class YCDUI_LIB_CLASS CWindowWnd
{
public:
    CWindowWnd();
...
//class YCDUI_LIB_CLASS CWaitCursor
//{
//public:
//    CWaitCursor();
//    ~CWaitCursor();
