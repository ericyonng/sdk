...
class YCDUI_LIB_CLASS CLabelUI : public CControlUI
{
public:
    CLabelUI();
...
//
//按钮控件
class YCDUI_LIB_CLASS CButtonUI : public CLabelUI
{
	//函数定义
public:
    CButtonUI();
...
//选择按钮
class YCDUI_LIB_CLASS CTabButtonUI : public CButtonUI
{
public:
    CTabButtonUI();
...
//复选控件
class YCDUI_LIB_CLASS CCheckButtonUI : public CLabelUI
{
public:
    CCheckButtonUI();
...
//单选按钮
class YCDUI_LIB_CLASS CRadioButtonUI : public CLabelUI
{
public:
    CRadioButtonUI();
...
class YCDUI_LIB_CLASS COptionUI : public CButtonUI
{
public:
    COptionUI();
    ~COptionUI();
...
class YCDUI_LIB_CLASS CTextUI : public CLabelUI
{
public:
    CTextUI();
    ~CTextUI();
...
/////////////////////////////////////////////////////////////////////////////////////
//
class YCDUI_LIB_CLASS CProgressUI : public CLabelUI
{
public:
    CProgressUI();
...
class YCDUI_LIB_CLASS CSliderUI : public CProgressUI
{
public:
    CSliderUI();
...
class YCDUI_LIB_CLASS CEditUI : public CLabelUI
{
    friend CEditWnd;
public:
    CEditUI();
...
class YCDUI_LIB_CLASS CScrollBarUI : public CControlUI
{
public:
    CScrollBarUI();
